...
const HowItWorks = () => {
  const steps = [
    {
      icon: CreditCard,
      title: "1. Reserva tu cupo",
      description: "Reserva tu web con $150.000 COP (50% del total)",
      highlight: "$150.000",
    },
    {
      icon: FileText,
  ...
  return (
    <section
      id="como-funciona"
      className="py-16 md:py-24 bg-gradient-to-b from-slate-950 to-black relative"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div
                    className="absolute -top-5 left-8 w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white rounded-xl flex items-center justify-center font-bold text-xl shadow-lg shadow-emerald-500/30"
                    aria-hidden="true"
                  >
                    {index + 1}
                  </div>
                  ...
                  <div className="mb-6 mt-4">
                    <div
                      className="inline-flex items-center justify-center w-16 h-16 bg-emerald-500/10 border border-emerald-400/20 rounded-2xl group-hover:bg-emerald-500/20 transition-colors"
                      aria-hidden="true"
                    >
          ...
          <div className="mt-12 max-w-3xl mx-auto">
            <div className="bg-slate-900/60 backdrop-blur-lg border-2 border-emerald-500/30 rounded-2xl p-8 text-center shadow-xl shadow-emerald-500/10">
              <p className="text-emerald-400 text-base font-semibold mb-2">
                Tiempo total:
              </p>
              <p className="text-3xl font-black text-white mb-4">5-7 días</p>
              <p className="text-slate-300 text-sm">
                Desde la reserva de tu diseño web profesional hasta tu página
                web online
              </p>
              <p className="text-emerald-400 text-base font-semibold mb-2 mt-6">
                ⚠️ Atención: Cupos Limitados
              </p>
              <p className="text-slate-300 text-sm">
                Para garantizar la máxima calidad y cumplir con la entrega en
                5-7 días, solo aceptamos 5 páginas web para negocios nuevas al
                mes en Colombia. Reserva tu cupo hoy antes de que se agoten.
              </p>
            </div>
          </div>
        </div>
